...
<c:if test="${empty list}">
  <div style="text-align: center;">
    <span><img src="${pageContext.request.contextPath}/images/hope.gif" width="100" height="100"/></span>
...
<div class="container cart">
  <div class="span24">
    <div class="step step1">
      <span style="line-height:60px; font-size:15px; font-weight:bold;">收藏信息</span>
    </div>
    <table>
      <tbody>
      <tr>
      ...
      <c:forEach var="c" items="${list}" >
        <tr>
          ...
          <td>
            <a href="${pageContext.request.contextPath}/delete.do?pid=${c.product.pid}" class="delete" title="删除" onclick="return confirm('确定要删除吗？')"> <img style="width: 32px;height:22px;" src="${pageContext.request.contextPath}/images/delete.jpg"/></a>
            <a href="${pageContext.request.contextPath}/productList.do?pid=${c.product.pid}" class="add" title="添加"> <img style="width: 20px;height:20px;" src="${pageContext.request.contextPath}/images/add.jpg"/></a>
          </td>
        </tr>
      </c:forEach>
      </tbody></table>
    ...
    <div class="bottom">
      <a href="${pageContext.request.contextPath}/clear.do" id="clear" class="clear" onclick="return confirm('确定要清空吗？')">清空收藏</a>
    </div>
  </div>
</div>
</c:if>
